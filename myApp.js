...
// <Your code here >
  ...
  let personSchema = new Schema({
    name : {
      type: String,
      required: true,
      default: "Ibrahim Abdullahi Aliyu",
    },
    age: Number,
...
// 'arrayOfPeople'.
 let arrayOfPeople = [
   {name: "Quincy", age: 39, favoriteFoods: ["Marshlow", "CodingFish"]},
   {name: "MZ Marshal", age:25, favoriteFoods: ["Gurasa", "Anything JS"]}
 ];
...
var queryChain = function(done) {
  ...
  let peopleFood = {favoriteFoods:foodToSearch}
  Person.find(peopleFood)
  .sort({name: 1})
  .limit(2)
  .select({age:0})
  .exec((err, data)=> {
